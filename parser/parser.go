...
type (
	...
	// ast.Expression param is the left side expression
...
func New(l *lexer.Lexer) *Parser {
	...
	// IndexExpressoin is infix because we are assuming the [ in myArray[idx] to be the infix operator
	// myArray will be the left operand and idx will be the right operand
